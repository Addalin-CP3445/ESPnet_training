...
dataset_path = './arabic-speech-corpus/test set'  # Replace with your dataset root directory
...
kaldi_data_dir = './arabic-speech-corpus/kaldi_data/test'  # Update this as needed
